...
{% include image.html url="/images/vqa_example.png" caption="An example of free-form, open-ended question of VQA task requiring common sense knowledge along with a visual understanding of the scene to answer questions." width=300 align="right" %}
